...
class MagicWand(Arma):
    def __init__(self):
        ...
        self.cooldown = 1000  # milissegundos
        self.ultimo_tiro = 0
        
    def attack(self, x, y, alvo_x, alvo_y):
        ...
        # direção fixa calculada apenas no momento do disparo
        dx = alvo_x - x
        dy = alvo_y - y
